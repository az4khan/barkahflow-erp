...
const PATHS = {
  ...
  suppliers:    <><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></>,
  ...
  store:        <><path d="M3 9l1-7h16l1 7"/><path d="M9 9v12h6V9"/><path d="M3 9h18"/><path d="M3 9c0 1.1.9 2 2 2s2-.9 2-2M7 9c0 1.1.9 2 2 2s2-.9 2-2m2 0c0 1.1.9 2 2 2s2-.9 2-2m2 0c0 1.1.9 2 2 2s2-.9 2-2"/></>,
  ...
  breakdown:    <><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></>,
  ...
  phone:        <><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.8 19.79 19.79 0 01.67 1.14 2 2 0 012.65.06h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L6.91 8a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z"/></>,
